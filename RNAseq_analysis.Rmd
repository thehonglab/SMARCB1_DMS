...
# Create a new column 'gene_group' indicating the cluster
...
# Create a separate annotation data frame for gene group
annotation_df <- data.frame(Gene_Group = all_heatmap_input$gene_group)

# Reorder columns to match your sample names
