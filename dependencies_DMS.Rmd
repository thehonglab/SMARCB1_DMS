...
rsa_data <- read_tsv("./data/dependency_analysis/smarcb1_rsa.tsv", 
...
rsa_data_filt <- rsa_data_filt %>%
  dplyr::left_join(ss_data %>% dplyr::select(ResNum, SS_Type), by = "ResNum")
...
write_xlsx(structural_summary, "./results/dependency_analysis/structural_summary.xlsx")

write_xlsx(combined_data, "./results/dependency_analysis/combined_data.xlsx")
```
